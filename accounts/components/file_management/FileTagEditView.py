...
class FileTagEditView(APIView):
        ...
        if generate:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    return JsonResponse({'message': 'Tags processed and saved successfully.', 'tags': tags}, status=200)
            ...
            try:
                ...
                tags = list(user_file.tags.values_list('name', flat=True))
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return JsonResponse({'error': 'File does not exist or you do not have permission to access it.'},
                                status=404)
